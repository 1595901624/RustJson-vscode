...
module.exports.parse_json_default = function(json) {
    ...
    try {
        ...
        wasm.parse_json_default(retptr, ptr0, len0);
...
* @returns {string}
*/
module.exports.parse_json = function(json, params_js_value) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.parse_json(retptr, ptr0, len0, addHeapObject(params_js_value));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
